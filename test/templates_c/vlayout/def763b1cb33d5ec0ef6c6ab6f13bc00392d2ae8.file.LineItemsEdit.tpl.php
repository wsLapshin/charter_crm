<?php /* Smarty version Smarty-3.1.7, created on 2016-01-01 02:16:08
         compiled from "/home/c/charter7ru/crm/public_html/includes/runtime/../../layouts/vlayout/modules/Inventory/LineItemsEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:35107147256755d578a0626-24173818%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'def763b1cb33d5ec0ef6c6ab6f13bc00392d2ae8' => 
    array (
      0 => '/home/c/charter7ru/crm/public_html/includes/runtime/../../layouts/vlayout/modules/Inventory/LineItemsEdit.tpl',
      1 => 1451614567,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '35107147256755d578a0626-24173818',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_56755d57b01d5',
  'variables' => 
  array (
    'RELATED_PRODUCTS' => 0,
    'FINAL' => 0,
...
<?php if ($_valid && !is_callable('content_56755d57b01d5')) {function content_56755d57b01d5($_smarty_tpl) {?>
...
" /><table style="display:none" class="table table-bordered blockContainer lineItemTable" id="lineItemTab"><tr><th colspan="2"><span class="inventoryLineItemHeader"><?php echo vtranslate('LBL_ITEM_DETAILS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</strong></button></div><?php }?></div></div><table style="display:none" class="table table-bordered blockContainer lineItemTable" id="lineItemResult"><tr style="display:none;"><td  width="83%"><div class="pull-right"><strong><?php echo vtranslate('LBL_ITEMS_TOTAL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</strong></button></div></div><!-- End Popup Div --></td></tr><tr style="display:none;"><td width="83%"><span class="pull-right">(+)&nbsp;<b><?php echo vtranslate('LBL_SHIPPING_AND_HANDLING_CHARGES',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0<?php }?>" /></span></td></tr><tr style="display:none;"><td width="83%"><span class="pull-right"><b><?php echo vtranslate('LBL_PRE_TAX_TOTAL',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
<?php }else{ ?>0<?php }?>"/></td></tr><!-- Group Tax - starts --><tr style="display:none;" id="group_tax_row" valign="top" class="<?php if ($_smarty_tpl->tpl_vars['IS_INDIVIDUAL_TAX_TYPE']->value){?>hide<?php }?>"><td width="83%"><span class="pull-right">(+)&nbsp;<b><a href="javascript:void(0)" id="finalTax"><?php echo vtranslate('LBL_TAX',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0<?php }?></span></td></tr><!-- Group Tax - ends --><tr style="display:none;"><td width="83%"><span class="pull-right">(+)&nbsp;<b><a href="javascript:void(0)" id="shippingHandlingTax"><?php echo vtranslate('LBL_TAX_FOR_SHIPPING_AND_HANDLING',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
" /><input type="hidden" name="subtotal" id="subtotal" value="" /><input type="hidden" name="total" id="total" value="" />
    <script>
        ...
        $(window).on('load', function(){
            $('#SalesOrder_editView_fieldName_cf_773').on('change', function(){
                var sum = $(this).val();
                $('#listPrice1').val(sum);
                $('#listPrice1').trigger('change');
            });
        });
    </script>
