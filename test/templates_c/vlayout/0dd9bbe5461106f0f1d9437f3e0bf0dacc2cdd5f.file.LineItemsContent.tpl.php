<?php /* Smarty version Smarty-3.1.7, created on 2016-01-01 00:04:18
         compiled from "/home/c/charter7ru/crm/public_html/includes/runtime/../../layouts/vlayout/modules/Inventory/LineItemsContent.tpl" */ ?>
<?php /*%%SmartyHeaderCode:117947877356755d57b0ac38-90560961%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0dd9bbe5461106f0f1d9437f3e0bf0dacc2cdd5f' => 
    array (
      0 => '/home/c/charter7ru/crm/public_html/includes/runtime/../../layouts/vlayout/modules/Inventory/LineItemsContent.tpl',
      1 => 1451606651,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '117947877356755d57b0ac38-90560961',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_56755d57de902',
  'variables' => 
  array (
    'row_no' => 0,
    'entityIdentifier' => 0,
...
<?php if ($_valid && !is_callable('content_56755d57de902')) {function content_56755d57de902($_smarty_tpl) {?>
...
" data-validation-engine="validate[required]" <?php if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['productName']->value])){?> disabled="disabled" <?php }?>/>--><input type="text" id="<?php echo $_smarty_tpl->tpl_vars['productName']->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars['productName']->value;?>
" value="<?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['productName']->value];?>
" class="productName <?php if ($_smarty_tpl->tpl_vars['row_no']->value!=0){?> autoComplete <?php }?>" placeholder="<?php echo vtranslate('LBL_TYPE_SEARCH',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
" class="selectedModuleId"/>--><input type="hidden" id="<?php echo $_smarty_tpl->tpl_vars['hdnProductId']->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars['hdnProductId']->value;?>
" value="13" class="selectedModuleId"/><!--<input type="hidden" id="lineItemType<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
" name="lineItemType<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
" value="<?php echo $_smarty_tpl->tpl_vars['entityType']->value;?>
" class="lineItemType"/>--><input type="hidden" id="lineItemType<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
" name="lineItemType<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
" value="Services" class="lineItemType"/><?php if ($_smarty_tpl->tpl_vars['row_no']->value==0){?><img class="lineItemPopup cursorPointer alignMiddle" data-popup="ServicesPopup" title="<?php echo vtranslate('Services',$_smarty_tpl->tpl_vars['MODULE']->value);?>
