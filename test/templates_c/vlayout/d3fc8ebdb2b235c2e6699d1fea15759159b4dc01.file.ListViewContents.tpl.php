<?php /* Smarty version Smarty-3.1.7, created on 2016-01-17 06:29:36
         compiled from "/home/c/charter7ru/crm/public_html/includes/runtime/../../layouts/vlayout/modules/Vtiger/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:49951090856755d0637a1d6-59881278%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd3fc8ebdb2b235c2e6699d1fea15759159b4dc01' => 
    array (
      0 => '/home/c/charter7ru/crm/public_html/includes/runtime/../../layouts/vlayout/modules/Vtiger/ListViewContents.tpl',
      1 => 1453012171,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '49951090856755d0637a1d6-59881278',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_56755d064cb11',
  'variables' => 
  array (
    'VIEW' => 0,
    'PAGING_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_56755d064cb11')) {function content_56755d064cb11($_smarty_tpl) {?>
<style>/*LIST VIEW*/.listViewEntriesTable {font-size:11px;table-layout:fixed;border-collapse:collapse;padding-left: 0;padding-right: 0;}.listViewEntriesTable th,.listViewEntriesTable td {width: 70px;}</style><input type="hidden" id="view" value="<?php echo $_smarty_tpl->tpl_vars['VIEW']->value;?>
...
?><?php $_smarty_tpl->tpl_vars['WIDTH'] = new Smarty_variable($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('listviewwidth'), null, 0);?><th   <?php if (!empty($_smarty_tpl->tpl_vars['WIDTH']->value)){?> style="width:<?php echo $_smarty_tpl->tpl_vars['WIDTH']->value;?>
px;" <?php }?>><a href="javascript:void(0);" class="listViewHeaderValues" data-nextsortorderval="<?php if ($_smarty_tpl->tpl_vars['COLUMN_NAME']->value==$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('column')){?><?php echo $_smarty_tpl->tpl_vars['NEXT_SORT_ORDER']->value;?>
...
&nbsp;&nbsp;<?php if ($_smarty_tpl->tpl_vars['COLUMN_NAME']->value==$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('column')){?><img class="<?php echo $_smarty_tpl->tpl_vars['SORT_IMAGE']->value;?>
 icon-white"><?php }?></a></th><?php } ?><th></th></tr></thead><?php if ($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->isQuickSearchEnabled()){?><tr><td></td><?php  $_smarty_tpl->tpl_vars['LISTVIEW_HEADER'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['LISTVIEW_HEADERS']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->total= $_smarty_tpl->_count($_from);
 $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->iteration=0;
foreach ($_from as $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->key => $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value){
...
$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->_loop = true;
 $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->iteration++;
 $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->last = $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->iteration === $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->total;
?><?php $_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME'] = new Smarty_variable($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('name'), null, 0);?><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value=='cf_773'){?><?php $_smarty_tpl->tpl_vars['entryRawData'] = new Smarty_variable($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getRawData(), null, 0);?><?php $_smarty_tpl->tpl_vars['coloredBill'] = new Smarty_variable($_smarty_tpl->tpl_vars['entryRawData']->value['colored_bill'], null, 0);?><?php $_smarty_tpl->tpl_vars['colorStyle'] = new Smarty_variable((('style="background:').($_smarty_tpl->tpl_vars['coloredBill']->value)).(';"'), null, 0);?><?php $_smarty_tpl->tpl_vars['summaryData'] = new Smarty_variable('data-summary="payment"', null, 0);?><?php }elseif($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value=='cf_791'){?><?php $_smarty_tpl->tpl_vars['entryRawData'] = new Smarty_variable($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getRawData(), null, 0);?><?php $_smarty_tpl->tpl_vars['coloredDriver'] = new Smarty_variable($_smarty_tpl->tpl_vars['entryRawData']->value['colored_driver'], null, 0);?><?php $_smarty_tpl->tpl_vars['colorStyle'] = new Smarty_variable((('style="background:').($_smarty_tpl->tpl_vars['coloredDriver']->value)).(';"'), null, 0);?><?php $_smarty_tpl->tpl_vars['summaryData'] = new Smarty_variable('data-summary="driver"', null, 0);?><?php }elseif($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value=='cf_793'){?><?php $_smarty_tpl->tpl_vars['summaryData'] = new Smarty_variable('data-summary="manager"', null, 0);?><?php $_smarty_tpl->tpl_vars['colorStyle'] = new Smarty_variable('', null, 0);?><?php $_smarty_tpl->tpl_vars['summaryData'] = new Smarty_variable('', null, 0);?><?php }else{ ?><?php $_smarty_tpl->tpl_vars['colorStyle'] = new Smarty_variable('', null, 0);?><?php $_smarty_tpl->tpl_vars['summaryData'] = new Smarty_variable('', null, 0);?><?php }?><td <?php echo $_smarty_tpl->tpl_vars['colorStyle']->value;?>
 <?php echo $_smarty_tpl->tpl_vars['summaryData']->value;?>
 class="listViewEntryValue <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
" data-field-type="<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getFieldDataType();?>
" ><?php if (($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->isNameField()==true||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('uitype')=='4')&&$_smarty_tpl->tpl_vars['MODULE_MODEL']->value->isListViewNameFieldNavigationEnabled()==true){?><a href="<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->getDetailViewUrl();?>
...
" class="icon-trash alignMiddle"></i></a><?php }?></span></div></td><?php }?></td><?php } ?></tr><?php } ?></table>
<script>
...
<!--added this div for Temporarily --><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value=='0'){?><table class="emptyRecordsDiv"><tbody><tr><td><?php $_smarty_tpl->tpl_vars['SINGLE_MODULE'] = new Smarty_variable("SINGLE_".($_smarty_tpl->tpl_vars['MODULE']->value), null, 0);?><?php echo vtranslate('LBL_EQ_ZERO');?>
 <?php echo vtranslate($_smarty_tpl->tpl_vars['MODULE']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
