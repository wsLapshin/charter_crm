...
{strip}
    ...
    <table style="display:none" class="table table-bordered blockContainer lineItemTable" id="lineItemTab">
        <tr>
    ...
    <table style="display:none" class="table table-bordered blockContainer lineItemTable" id="lineItemResult">
		...
		<!-- Group Tax - starts -->
        <tr style="display:none;" id="group_tax_row" valign="top" class="{if $IS_INDIVIDUAL_TAX_TYPE}hide{/if}">
            <td width="83%">
