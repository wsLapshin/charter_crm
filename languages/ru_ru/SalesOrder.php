...
$languageStrings = array(
	...
	'Sales Commission'             => 'Себестоимость'    , 
    ...
    'Billing Address'              => 'Адрес загрузки',
    'LBL_COPY_SHIPPING_ADDRESS'    => 'Адрес выгрузки' ,
    'LBL_ADDRESS_INFORMATION'      => 'Адреса',
    'LBL_DESCRIPTION_INFORMATION'  => 'Комментарии',
    'Description'                  => 'Комментарии'            ,
    'LBL_CUSTOM_INFORMATION'       => 'Исполнение',
    'Created Time'                      => 'Заказ принят',
    'Created'                      => 'Принят'              , // KEY 5.x: LBL_CREATED
	'Approved'                     => 'Исполняется'                    , 
	'Delivered'                    => 'Доставлен'                   , 
	'Cancelled'                    => 'Отменен'                   ,
    'Shipping Address'             => 'Адрес выгрузки' ,
    'Subject'                      => 'Номер счета',
    'LBL_SYSTEM_HIDDEN'            => 'Системные поля (скрыты в шаблоне tpl)',  
);
